...
public class Services {
    ...
    @Autowired
    public Services(StudentDataAccessService studentDataAccessService,
    ...
    List<Courses> getAllCourseForStudent(UUID studentId)
    {
        return studentDataAccessService.selectAllCourses(studentId);
    }
